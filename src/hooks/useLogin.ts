...
export function useLogin () {
    ...
    const handleChangeLogin = (e: ChangeEvent<HTMLInputElement>) => setUserName(e.target.value)
    ...
    return {handleAuth, handleChangeLogin, handleChangePassword, password, userName}
}